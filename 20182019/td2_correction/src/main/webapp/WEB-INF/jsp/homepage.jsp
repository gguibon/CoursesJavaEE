...
<!-- Exemple d'import normal (commenté) ou avec webjars (ligne suivante) -->
		...
		<div class="row">
			...
			<div class="col-lg-3">
				...
				<div class="list-group">
					<form id="allfilter" action="${pageContext.request.contextPath}/category" method="POST">
						<input type="hidden" value="all" name="category" />
						<a class="list-group-item" href="javascript:{}" onclick="document.getElementById('allfilter').submit(); return false;">ALL</a>
					</form>
					<form id="computerfilter" action="${pageContext.request.contextPath}/category" method="POST">
						<input type="hidden" value="computer" name="category" />
						<a class="list-group-item" href="javascript:{}" onclick="document.getElementById('computerfilter').submit(); return false;" >Computer</a>
					</form>
					<form id="clothesfilter" action="${pageContext.request.contextPath}/category" method="POST">
						<input type="hidden" value="clothes" name="category" />
						<a class="list-group-item" href="javascript:{}" onclick="document.getElementById('clothesfilter').submit(); return false;">Clothes</a>
					</form>
					<form id="moviesfilter" action="${pageContext.request.contextPath}/category" method="POST">
						<input type="hidden" value="movies" name="category" />
						<a class="list-group-item" href="javascript:{}" onclick="document.getElementById('moviesfilter').submit(); return false;">Movies</a>
					</form>
				</div>
			...
			<div class="col-lg-9">
				...
				<div class="my-4 row">
					<!-- version pour générer un produit arbitraire 
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form id="addproductform" action="${pageContext.request.contextPath}/add" method="POST">
									...
									<div class="form-group">
										<label for="descriptioninput">Description:</label> <input
											type="text" class="form-control" id="descriptioninput" name="description"></input>
									</div>
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-primary"
									data-dismiss="modal" onclick="document.getElementById('addproductform').submit(); return false;">Confirm</button>
							</div>
						</div>
